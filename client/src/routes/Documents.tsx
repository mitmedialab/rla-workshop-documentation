    ...
    return (
      <div className="uk-padding uk-section uk-section-secondary page-content">
        <table className="uk-table uk-table-small uk-table-middle">
          <tbody>
            <tr>
              <td className="limit-width"><a className="uk-button uk-button-primary" href="https://drive.google.com/open?id=1CFoO69vGhimnAozX2Gdl4WaIDNpVpH4H">Sessions</a></td>
              <td>Slide decks and worksheets from throughout the week</td>
            </tr>
            <tr>
              <td className="limit-width"><a className="uk-button uk-button-primary" href="https://drive.google.com/drive/folders/1bMuOHSuXzpQQ0ZqPuP07GCTaGuRlmMSq?usp=sharing">Learnings</a></td>
